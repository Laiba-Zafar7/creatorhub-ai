        ...
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 w-full text-gray-500 mt-20">
            <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
                <div className="md:max-w-96">
                    <img className="w-32 sm:w-44 rounded-md
 cursor-pointer" src={assets.logo7} alt="logo"  />
                    <p className="mt-6 text-sm">
                       Experience the Power of AI with CreatorHub AI <br /> Transform your content creation with our suite of premium AI Tools. Write articles, generate images, and enhance your workflow.
                    </p>
                    <div className="mt-4 text-sm space-y-1">
                        <p><strong>Contact:</strong> zaafarlaiba@gmail.com</p>
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    <div>
                        ...
                        <ul className="text-sm space-y-2">
                            ...
                            <li><a href="mailto:zaafarlaiba@gmail.com" className="hover:text-primary transition-colors">Contact</a></li>
                        </ul>
                    </div>
                    <div>
